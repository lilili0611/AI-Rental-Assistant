...
对接飞书数据、面向客户与内部员工的 AI 租赁管理助手。当前 **v2.10.1** 已修复手机端 AI 输入键盘引起的放大溢出，并将登录后右上角改为仅显示“我的”的线性猫头入口。

线上地址：[https://bozipaopao.cn/](https://bozipaopao.cn/)（Vercel 托管，当前版本 v2.10.1）。
