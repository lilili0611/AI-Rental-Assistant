...
对接飞书数据、面向客户与内部员工的 AI 租赁管理助手。当前 **v2.10.2** 已修复手机端 AI 键盘收起时透出底页的问题，并支持“明天租，后天还”、`7/20~7/23` 等多格式租期表达。

线上地址：[https://bozipaopao.cn/](https://bozipaopao.cn/)（Vercel 托管，当前版本 v2.10.2）。
...
覆盖 Spec §9/§13–§16/§20–§22 关键路径：按日期库存、价格边界、预留释放、订单状态机、人工收款、收货地址校验与权限、个人信息脱敏、知识库优先、四类咨询路由、LLM 180 字硬上限、多轮导购、移动端语音降级、用户资料与密码安全、设备/租期/收货信息下单带入、陪伴提醒和安全排障。
