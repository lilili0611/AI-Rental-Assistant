...
对接飞书数据、面向客户与内部员工的 AI 租赁管理助手。当前 **v2.9.5** 已支持导购确认设备与租期后一键带入下单页，并可安全预填客户主动提供的收货信息。

线上地址：[https://bozipaopao.cn/](https://bozipaopao.cn/)（Vercel 托管，当前版本 v2.9.5）。
...
覆盖 Spec §9/§13–§16/§20–§21 关键路径：按日期库存、价格边界、预留释放、订单状态机、人工收款、收货地址校验与权限、个人信息脱敏、知识库优先、四类咨询路由、LLM 180 字硬上限、多轮导购、设备/租期/收货信息下单带入、陪伴提醒和安全排障。
