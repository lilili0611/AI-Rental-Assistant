...
对接飞书数据、面向客户与内部员工的 AI 租赁管理助手。当前 **v2.10.0** 已增加手机端独立 AI 对话与按住说话入口，并提供头像、账号密码和本人订单统一管理的“我的”中心。

线上地址：[https://bozipaopao.cn/](https://bozipaopao.cn/)（Vercel 托管，当前版本 v2.10.0）。
